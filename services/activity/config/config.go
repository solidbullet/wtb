...
func Load() *Config { return &Config{Port: getEnvInt("PORT", 8087), DSN: getEnv("DATABASE_DSN", "host=/tmp user=admin dbname=wtb_activity sslmode=disable TimeZone=Asia/Shanghai"), JWTSecret: getEnv("JWT_SECRET", "dev-secret-change-in-production")} }
