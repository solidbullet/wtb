...
func (r *OrderItemRepo) DB() *gorm.DB { return r.db }

func (r *OrderItemRepo) Create(item *model.OrderItem) error {
	return r.db.Create(item).Error
}

func (r *OrderItemRepo) ListByOrder(orderID uint) ([]model.OrderItem, error) {
